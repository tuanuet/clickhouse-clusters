...
gen-clickhouse-config:
	...
	SERVER_ID=2 envsubst < ${BASE_CONFIG_DIR}/enable_keeper.xml > ${GEN_CONFIG_DIR}/clickhouse-green-1/enable_keeper.xml
	...
	SERVER_ID=3 envsubst < ${BASE_CONFIG_DIR}/enable_keeper.xml > ${GEN_CONFIG_DIR}/clickhouse-orange-1/enable_keeper.xml
